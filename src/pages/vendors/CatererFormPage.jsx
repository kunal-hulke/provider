...
const CatererFormPage = () => {
  ...
  const [newMenuItem, setNewMenuItem] = useState({ itemName: '', itemPrice: '' });
  const [newCustomItem, setNewCustomItem] = useState({ itemName: '', itemPrice: '' });
  ...
  const addCustomizableItem = () => {
    if (newCustomItem.itemName && newCustomItem.itemPrice) {
      setFormData(prev => ({
        ...prev,
        customizableItems: [...prev.customizableItems, {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    toast.success(isEditing ? 'Caterer updated successfully!' : 'Caterer added successfully!');
    navigate('/vendors');
  };
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Input
                ...
                onChange={(e) => handleInputChange('catererName', e.target.value)}
                  ...
                  {mandaps.map((mandap) => (
                    <label key={mandap.id} className="flex items-center mb-2">
                      <input
                        ...
                        onChange={() => handleArrayToggle('mandapId', mandap.id)}
                        className="mr-2"
                      />
                      <span className="text-sm">{mandap.mandapName || mandap.name}</span>
                    </label>
                  ))}
                </div>
              </div>
            ...
            <div>
              ...
              {formData.menuCategories.map((category, categoryIndex) => (
                <div key={categoryIndex} className="bg-yellow-50 p-4 rounded-lg mb-4 border">
                  <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
                    <Select
                      ...
                      onChange={(value) => updateMenuCategory(categoryIndex, 'category', value)}
                      fullWidth
                    />
                    ...
                    <Input
                      ...
                      onChange={(e) => updateMenuCategory(categoryIndex, 'pricePerPlate', e.target.value)}
                      placeholder="₹ 0"
                      fullWidth
                    />
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 mb-2">
                      <Input
                        ...
                        onChange={(e) => setNewMenuItem(prev => ({ ...prev, itemName: e.target.value }))}
                        fullWidth
                      />
                      <Input
                        placeholder="Price"
                        ...
                        onChange={(e) => setNewMenuItem(prev => ({ ...prev, itemPrice: e.target.value }))}
                    ...
                    <div className="space-y-2">
                      {category.menuItems.map((item, itemIndex) => (
                        <div key={itemIndex} className="flex items-center justify-between bg-white p-2 rounded border">
                          <span className="text-sm">{item.itemName} - ₹{item.itemPrice}</span>
                          <Button
                            type="button"
              ...
              <div>
                <label className="flex items-center">
                  <input
                    ...
                    onChange={(e) => handleInputChange('hasTastingSession', e.target.checked)}
                    className="mr-2"
                  />
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-2 mb-2">
                  <Input
                    ...
                    onChange={(e) => setNewCustomItem(prev => ({ ...prev, itemName: e.target.value }))}
                    fullWidth
                  />
                  <Input
                    placeholder="Price"
                    ...
                    onChange={(e) => setNewCustomItem(prev => ({ ...prev, itemPrice: e.target.value }))}
                    className="w-full sm:w-32"
                  />
                  <Button
                    type="button"
