...
const RoomFormPage = () => {
  ...
  const acAmenities = [
    'WiFi', 'TV', 'AirConditioning', 'MiniBar', 'RoomService', 'Balcony', 'Desk', 'Safe'
  ];

  const nonAcAmenities = [
    'WiFi', 'TV', 'Fan', 'RoomService', 'Balcony', 'Desk', 'Safe'
  ];
  ...
  const removeImage = (roomType, imageIndex) => {
    setFormData(prev => ({
      ...
      [roomType]: {
        ...prev[roomType],
        roomImages: prev[roomType].roomImages.filter((_, i) => i !== imageIndex)
      }
    }));
  };
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
                <Input
                  ...
                  onChange={(e) => handleInputChange('AcRoom.noOfRooms', e.target.value)}
                  min="0"
                  fullWidth
                />
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('AcRoom.pricePerNight', e.target.value)}
                  min="0"
                  fullWidth
                />
              </div>
              ...
              <div className="mb-4">
                <label className="block text-sm font-medium text-gray-700 mb-2">AC Room Amenities</label>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">AC Room Images</label>
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center mb-4">
                  <Upload className="mx-auto h-12 w-12 text-gray-400" />
                  <p className="mt-2 text-sm text-gray-600">Upload AC room images</p>
                  <input 
                    type="file" 
                    multiple 
                    accept="image/*" 
                    className="hidden" 
                    id="ac-room-images"
                    onChange={(e) => handleImageUpload('AcRoom', e.target.files)}
                  />
                  <label 
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                    {formData.AcRoom.roomImages.map((image, index) => (
                      <div key={index} className="relative">
                        <img src={image} alt={`AC Room ${index + 1}`} className="w-full h-32 object-cover rounded" />
                        <button
                          type="button"
            ...
            <div className="bg-yellow-50 p-4 rounded-lg">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
                <Input
                  ...
                  onChange={(e) => handleInputChange('NonAcRoom.noOfRooms', e.target.value)}
                  min="0"
                  fullWidth
                />
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('NonAcRoom.pricePerNight', e.target.value)}
                  min="0"
                  fullWidth
                />
              </div>
              ...
              <div className="mb-4">
                <label className="block text-sm font-medium text-gray-700 mb-2">Non-AC Room Amenities</label>
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-2">
                  {nonAcAmenities.map((amenity) => (
                    <label key={amenity} className="flex items-center">
                      <input
                        ...
                        onChange={() => handleAmenityToggle('NonAcRoom', amenity)}
                        className="mr-2"
                      />
                      <span className="text-sm">{amenity}</span>
                    </label>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Non-AC Room Images</label>
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center mb-4">
                  <Upload className="mx-auto h-12 w-12 text-gray-400" />
                  <p className="mt-2 text-sm text-gray-600">Upload Non-AC room images</p>
                  <input 
                    type="file" 
                    multiple 
                    accept="image/*" 
                    ...
                    onChange={(e) => handleImageUpload('NonAcRoom', e.target.files)}
                  />
                  <label 
                ...
                {formData.NonAcRoom.roomImages.length > 0 && (
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                    {formData.NonAcRoom.roomImages.map((image, index) => (
                      <div key={index} className="relative">
                        <img src={image} alt={`Non-AC Room ${index + 1}`} className="w-full h-32 object-cover rounded" />
                        <button
                          type="button"
